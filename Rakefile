...
task :changelog, :from, :to do |t, args|
  ...
  puts "Workarea Cyber Source #{Workarea::CyberSource::VERSION} (#{Date.today})"
  puts "-" * 80
  puts
...
desc "Release version #{Workarea::CyberSource::VERSION} of the gem"
task :release do
...
$(cat CHANGELOG.md)" > CHANGELOG.md'
  ...
  system "gem push workarea-cyber_source-#{Workarea::CyberSource::VERSION}.gem --host #{host}"
  system "rm workarea-cyber_source-#{Workarea::CyberSource::VERSION}.gem"
end
